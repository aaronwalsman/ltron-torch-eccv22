...
from ltron_torch.models.deeplabv3 import mobilenetv3
import ltron_torch.models.deeplabv3.resnet as resnet
...
from ltron_torch.models.deeplabv3.fcn import FCNHead
...
def _deeplabv3_resnet(
    ...
    for name, num_class in heads.items():
        classifier[name] = DeepLabHead(2048, num_class)
    return DeepLabV3(backbone, classifier, aux_classifier, target_shape)
...
def deeplabv3_resnet50(
    ...
    model = _deeplabv3_resnet(backbone, num_classes, aux_loss, heads=heads)
